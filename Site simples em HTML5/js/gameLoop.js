...
function rodada(sqr){
    if(sqr.value == EMPTY_val){
        if(turno == 1){
            sqr.value = X_val;
            sqr.style.backgroundColor = "#B21212";
        }else{            
            sqr.value = O_val;
            sqr.style.backgroundColor = "#54A807";
        }
        turno = turno*(-1);
        validaJogada();
    }
...
function validaJogada(){
    ...
    if(
        ...
        (sqr3 == valorTurno && sqr5 == valorTurno && sqr7 == valorTurno)){
...
function reset(){
    ...
    document.velha.sqr1.style.backgroundColor = "#c4c4c4";  
    document.velha.sqr2.style.backgroundColor = "#c4c4c4";  
    document.velha.sqr3.style.backgroundColor = "#c4c4c4";  
    document.velha.sqr4.style.backgroundColor = "#c4c4c4";  
    document.velha.sqr5.style.backgroundColor = "#c4c4c4";  
    document.velha.sqr6.style.backgroundColor = "#c4c4c4";  
    document.velha.sqr7.style.backgroundColor = "#c4c4c4";  
    document.velha.sqr8.style.backgroundColor = "#c4c4c4";  
    document.velha.sqr9.style.backgroundColor = "#c4c4c4";
